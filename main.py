...
def first():
    if request.method == 'POST':
        ...
        sender_email = 'ernesto@grandedite.com'
        sender_emaill = 'ernesto'
        receiver_email = 'luna.standardglas@gmail.com'
        password = 'Ernestograndedite'
        ...
        with smtplib.SMTP_SSL('mail.grandedite.com', 465) as server:
